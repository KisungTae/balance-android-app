...
class PagerImpl<Key : Any, Value : Any>(
...
//    }
    ...
    fun withHeader(block: () -> Value): PagerImpl<Key, Value> {
        return this
    }

    fun withFooter(block: () -> Value): PagerImpl<Key, Value> {
        return this
    }

    fun withLoadStateLoading(block: () -> Value): PagerImpl<Key, Value> {
        return this
    }

    fun withLoadStateError(block: () -> Value): PagerImpl<Key, Value> {
        return this
    }
