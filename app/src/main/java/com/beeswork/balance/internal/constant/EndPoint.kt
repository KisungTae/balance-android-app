...
//        private const val BALANCE_WEB_URL = "192.168.1.119:8081"
        ...
        fun ofPhoto(photoDomain: String?, accountId: UUID?, photoKey: String?): String {
            return "$photoDomain${Delimiter.FORWARD_SLASH}$accountId${Delimiter.FORWARD_SLASH}$photoKey"
        }
    }
