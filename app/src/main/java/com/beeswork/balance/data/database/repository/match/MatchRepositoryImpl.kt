...
class MatchRepositoryImpl(
    ...
    override suspend fun loadMatches(loadSize: Int, startPosition: Int, matchPageFilter: MatchPageFilter?, sync: Boolean): List<Match> {
...
//        }
    ...
    override fun syncMatches(loadSize: Int, startPosition: Int?, matchPageFilter: MatchPageFilter?) {
