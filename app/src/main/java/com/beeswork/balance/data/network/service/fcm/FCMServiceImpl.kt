...
) : FirebaseMessagingService(), FCMService, KodeinAware {
...
//    private val applicationScope: CoroutineScope by instance()

    override fun onNewToken(token: String) {
//        applicationScope.launch { settingRepository.saveFCMToken(token) }
    }
...
//        }
    ...
    override fun test() {
        println("test here from fcm service")
    }
}